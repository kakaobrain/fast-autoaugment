...
# Usage:
#
#   DATA=cifar10 BATCH=32 /data/private/bin/task.sh
...
PYTHONPATH=/data/private/fast-autoaugment-public python train.py -c confs/resnet50_b4096.yaml --horovod --aug fa_reduced_imagenet'
# --save ./models/resnet50_b4096_faa.pth
# ------------------------------------------------------------------------------
